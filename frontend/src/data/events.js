...
const eventsList = [
    ...
    },
    {
        ...
        rules: [
            "The event will be conducted in solo format.",
            "Each team will consist of two (2) participants, including one (1) substitute.",
            "Participants must report on time at the venue. Late entries may be disqualified.",
            "The event will be conducted in knockout format.",
            "Each participant must complete the obstacle course in the given order: 30 m Crawl Race, Cone Picking Race (4 rows of cones), after U-turn clear Hurdle Race (hurdles in ascending height order), and finally complete a 50 m Sprint.",
            "Skipping any obstacle or performing them in the wrong sequence will lead to disqualification.",
            "If a participant fails to clear an obstacle, she must retry from the same point.",
            "Use of unfair means or intentional misconduct will result in immediate disqualification.",
            "Participants must follow all safety instructions given by the moderators.",
