...
function DefaultHeader({ title, image }) {
    return (
        <Paper elevation={3} sx={{ overflow: 'hidden', height: { xs: '200px', md: '280px' }, pt: { xs: 2, md: 0 }, background: `url(${image || bgPhoto}) no-repeat center`, backgroundSize: 'cover' }} >
